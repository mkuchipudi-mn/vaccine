...
export class VaccineService {
  ...
  public save_Vaccine(vaccine: any): Observable<any> {
    return this.http.post('/vaccine/save', vaccine).map((response: any) => response.json());
  }
  ...
  public getVaccine_param(id: any): Observable<any> {
  ...
  public update_Vaccine(vaccine: any): Observable<any> {
    return this.http.put('/vaccine/save', vaccine).map((response: Response) => response.json());
  }
}
